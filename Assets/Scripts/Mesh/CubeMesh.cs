...
public static class CubeMesh_Dir
    {
        public static readonly Vector3[] Verts = new Vector3[]
        {
        new Vector3(-0.5f,-0.5f,-0.5f) ,
        ...
        public static readonly Dictionary<Direction_Extended, BlockMesh> CubeMeshes = new Dictionary<Direction_Extended, BlockMesh>()
    {
        { Direction_Extended.Cube_Up, new BlockMesh()
        {
            Verts_N = Verts,
            Tris_N = Tris,
            UVs_N = UVs,
        ...
        { Direction_Extended.Cube_Down, new BlockMesh()
        {
        ...
        { Direction_Extended.Cube_Left, new BlockMesh()
        {
        ...
        { Direction_Extended.Cube_Right, new BlockMesh()
        {
        ...
        { Direction_Extended.Cube_Front, new BlockMesh()
        {
        ...
        { Direction_Extended.Cube_Back, new BlockMesh()
        {
...
public static class FurnitureMesh_Dir
{
    public static readonly Vector3[] Verts = new Vector3[]
    {
        new Vector3(-0.5f,-0.5f,-0.5f) ,
